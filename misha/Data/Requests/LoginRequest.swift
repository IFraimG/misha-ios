...
func login(with body: User, completion: @escaping (Result<ResponseSignupData, Error>) -> Void) {
    guard let url = URL(string: "http://95.163.221.125:8080/auth/users/login") else {
        print("Invalid URL")
        return
    }
